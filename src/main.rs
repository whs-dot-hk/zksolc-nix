...
async fn main() -> anyhow::Result<()> {
    ...
    let versions = vec![
        ...
        "1.3.10", "1.3.11", "1.3.13", "1.3.14", "1.3.16", "1.3.17", "1.3.18", "1.3.19", "1.3.21",
        "1.3.22", "1.3.23", "1.4.0", "1.4.1", "1.5.0", "1.5.1", "1.5.2", "1.5.3", "1.5.4", "1.5.5",
    ...
    for version in versions {
        ...
        let name = format!("zksolc_{}", version.replace(".", "_"));
