...

{
    zksolc_1_3_0 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.0";
        };
    };
    zksolc_1_3_1 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.1";
        };
    };
    zksolc_1_3_2 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.2";
        };
    };
    zksolc_1_3_3 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.3";
        };
    };
    zksolc_1_3_4 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.4";
        };
    };
    zksolc_1_3_5 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.5";
        };
    };
    zksolc_1_3_6 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.6";
        };
    };
    zksolc_1_3_7 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.7";
        };
    };
    zksolc_1_3_8 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.8";
        };
    };
    zksolc_1_3_9 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.9";
        };
    };
    zksolc_1_3_10 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.10";
        };
    };
    zksolc_1_3_11 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.11";
        };
    };
    zksolc_1_3_13 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.13";
        };
    };
    zksolc_1_3_14 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.14";
        };
    };
    zksolc_1_3_16 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.16";
        };
    };
    zksolc_1_3_17 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.17";
        };
    };
    zksolc_1_3_18 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.18";
        };
    };
    zksolc_1_3_19 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.19";
        };
    };
    zksolc_1_3_21 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.21";
        };
    };
    zksolc_1_3_22 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.22";
        };
    };
    zksolc_1_3_23 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.23";
        };
    };
    zksolc_1_4_0 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.4.0";
        };
    };
    zksolc_1_4_1 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.4.1";
        };
    };
    zksolc_1_5_0 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.0";
        };
    };
    zksolc_1_5_1 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.1";
        };
    };
    zksolc_1_5_2 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.2";
        };
    };
    zksolc_1_5_3 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.3";
        };
    };
    zksolc_1_5_4 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.4";
        };
    };
    zksolc_1_5_5 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.5";
        };
    };
    zksolc_1_5_6 = stdenv.mkDerivation {
        ...
        src = builtins.fetchurl {
            ...
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.6";
        };
    };
    ...
    zksolc_1_5_9 = stdenv.mkDerivation {
        dontBuild = true;
        dontUnpack = true;
        installPhase = "mkdir -p $out/bin; cp $src $out/bin/zksolc; chmod +x $out/bin/zksolc";
        pname = "zksolc";
        version = "1.5.9";
        src = builtins.fetchurl {
            sha256 = "sha256-U51fY3UEeRogB0NOHkLXXF37IOb0vD39RPXlUNC/GEQ=";
            url = "https://github.com/matter-labs/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.5.9";
        };
    };
}
